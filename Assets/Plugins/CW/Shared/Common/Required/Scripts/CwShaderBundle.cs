...
namespace CW.Common
{
    ...
    public class CwShaderBundle : ScriptableObject
    {
        ...
        public Shader Target { set { target = value; } get { return target; } }
        [SerializeField] private Shader target;

        /// <summary>The hash code of the currently loaded bundle.</summary>
        public int VariantHash { set { variantHash = value; } get { return variantHash; } }
        ...
        public int ProjectHash { set { projectHash = value; } get { return projectHash; } }
        [SerializeField] private int projectHash;

        /// <summary>This stores all shader variants for this shader.</summary>
        public List<ShaderVariant> Variants { get { if (variants == null) variants = new List<ShaderVariant>(); return variants; } }
